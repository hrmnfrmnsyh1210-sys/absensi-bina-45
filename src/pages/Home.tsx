...
import { QrCode, LayoutDashboard, UserSquare } from 'lucide-react';
        ...
        <div className="p-6 space-y-4 flex-1 mt-2">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium">Tampilkan QR Code</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h2 className="font-bold text-slate-800 text-lg">Pemindai QR</h2>
              <p className="text-sm text-slate-500 font-medium">Kamera Absensi Kelas</p>
            </div>
          </Link>

          <Link 
            to="/admin"
            className="flex items-center gap-4 p-4 rounded-2xl border border-slate-200 active:scale-[0.98] active:bg-purple-50 hover:bg-purple-50 transition-all group shadow-sm"
          >
            <div className="w-14 h-14 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 flex-shrink-0 shadow-sm">
              <LayoutDashboard className="w-7 h-7" />
            </div>
            <div>
              <h2 className="font-bold text-slate-800 text-lg">Dashboard</h2>
              <p className="text-sm text-slate-500 font-medium">Rekap Kehadiran Guru</p>
            </div>
          </Link>
        </div>
      </div>
